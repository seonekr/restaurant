...
function Menubar() {
  ...
  return (
    <div>
      <div className="menubar_contentHeader22">
        <div className="box_content_header2">
          ...
          <div className="menu_header_box2">
            {is_admin ? (
              <>
                <NavLink to="/mainpage" className="linkTomenu">
                  Home
                </NavLink>
                <NavLink to="/manageorder" className="linkTomenu">
                  Order
                </NavLink>
                <NavLink to="/dashboardpc" className="linkTomenu">
                  Dashboard
                </NavLink>
                <NavLink to="/counter" className="linkTomenu">
                  Counter
                </NavLink>
              </>
            ) : (
